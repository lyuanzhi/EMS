...
QT_MOC_LITERAL(1, 16, 11), // "getDateTime"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8) // "dateTime"

    },
    "DefDateTimeEdit\0getDateTime\0\0dateTime"
};
...
void DefDateTimeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DefDateTimeEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getDateTime((*reinterpret_cast< const QDateTime(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject DefDateTimeEdit::staticMetaObject = { {
    &QDateTimeEdit::staticMetaObject,
    qt_meta_stringdata_DefDateTimeEdit.data,
    qt_meta_data_DefDateTimeEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
